...
function Dashboard() {
  return (
    <Layout>
      <div className="h-[calc(100vh-62px)] sm:h-[calc(100vh-68px)] overflow-auto p-2 sm:p-5">
        <h1 className="text-2xl font-semibold mb-2">Recent Updates</h1>
            ...
            <div className="p-4 sm:p- bg-white rounded-[20px] h-full">
              ...
              <div className="mt-4 flex items-center">
                ...
                <p className="font-semibold">
                  Provide some workers with more clarity for the upcoming projects
                </p>
              </div>
            </div>
          </div>
        </div>
        <h1 className="text-2xl font-semibold mb-2 mt-2 sm:mt-4">
          Top Workers
        </h1>
